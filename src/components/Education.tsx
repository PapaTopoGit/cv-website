  ...
  return (
    <section id="education" className="py-32 px-6" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-violet-400 text-sm font-medium mb-4 tracking-wider uppercase">Academic Background</p>
        ...
        <div className="relative">
          ...
          {data.map((item, index) => (
            ...
            >
              <div className="glass-card p-6 md:w-[calc(50%-1rem)]">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white/90">{item.school}</h3>
                    <p className="text-sm text-white/40">{item.location}</p>
                  </div>
                </div>
                
                <p className="text-violet-300 font-medium mb-2">{item.degree}</p>
